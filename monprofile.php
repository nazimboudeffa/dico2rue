...
<div class="clear"></div>
<h1 class="profiletitle"><?php echo $_SESSION['username'] ?> <span><span>  </span></h1>
<a href="monprofile_edit.php" class="button right profileedit">Modifier mon profil</a><div class="clear"></div>
